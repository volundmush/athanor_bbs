...
class BBSCategoryBridge(SharedMemoryModel):
    db_script = models.OneToOneField('scripts.ScriptDB', related_name='bbs_category_bridge', primary_key=True,
...
class BBSBoardBridge(SharedMemoryModel):
    db_script = models.OneToOneField('scripts.ScriptDB', related_name='bbs_board_bridge', primary_key=True,
                                     on_delete=models.CASCADE)
    db_category = models.ForeignKey(BBSCategoryBridge, related_name='boards', null=False, on_delete=models.CASCADE)
    db_name = models.CharField(max_length=255, blank=False, null=False)
...
class BBSPost(models.Model):
    ...
    board = models.ForeignKey(BBSBoardBridge, related_name='posts', on_delete=models.CASCADE)
